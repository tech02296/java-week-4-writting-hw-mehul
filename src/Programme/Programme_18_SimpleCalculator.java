 ...
 * it needs to return the value of the firstNumber field.
 * Method named getSecondNumber without any parameters,
 * it needs to return the value of the secondNumber field.
 ...
 * it needs to return the result of adding the field values of
 * firstNumber and secondNumber.
 * Method named getSubtractionResult without any parameters,
 * it needs to return the result of subtracting the field
 * values of the secondNumber from the firstNumber.
 * Method named getMultiplicationResult without any parameters,
 * it needs to return the result of multiplying the
 * field values of firstNumber and secondNumber.
 * Method named getDivisionResult without any parameters,
 * it needs to return the result of dividing the field
 * values of firstNumber by the secondNumber. In case the value of
